...
// Show More/Less Feature Toggle
// Set to true to enable content truncation with expand/collapse buttons
// Set to false to show all content fully expanded (default)
export const ENABLE_SHOW_MORE = false;
